const text = {
  ar: {
    ...
    products: 'المنتجات', wallet: 'المحفظة', orders: 'طلباتي', support: 'الدعم', language: 'عربي / English',
    ...
    payWallet: 'من المحفظة', payBinance: 'Binance ID', paySuperQi: 'سوبركي',
  ...
  en: {
    ...
    products: 'Products', wallet: 'Wallet', orders: 'My orders', support: 'Support', language: 'عربي / English',
    ...
    payWallet: 'Wallet', payBinance: 'Binance ID', paySuperQi: 'SuperQi',
